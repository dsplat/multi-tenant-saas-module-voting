...
class VotingUpdateHandler implements ToolHandlerContract
{
    public function __construct(private readonly VotingService $service) {}

    public function __invoke(array $arguments, int $tenantId): mixed
    {
        return $this->service->updateVote((int) $arguments['vote_id'], $arguments['title'] ?? null, $arguments['status'] ?? null);
    }
}
